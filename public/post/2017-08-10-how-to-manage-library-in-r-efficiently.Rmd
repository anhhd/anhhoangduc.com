...
When starting using with R, installing and mananing R libraries seems not to be a difficult task at all. However, when updating R to new version, it will make some problems. For most cases, you have to reinstall your library, which takes much time. 
...
Therefore, I found a very efficient way that can simplify all theses diffculties above in few easy steps.
...
- **Step 3**: Now, you have to make R understand `D:/Rlibrary` (new folder) is your default libraries, all new libraries will be installed to that folder.
    - Open RStudio to find your R library paths
...
Restart Rstudio and when typing `.libPaths()`, you will see your default library changed to `D:/Rlibrary`
...
After doing it, you can see all libraries from all R version, `R` from Cran, `R Server` & `R Service` from Microsoft syncrozied! When you install a new library from Cran, you `R Service` from SQLRServer can use it, too! Really fantastic!

![](/img/sqlrserver.png)

Isn't it great! For me, this little trick help me alot! Hope that you will enjoy it and find it helpful! Let me know if you have any comment!
